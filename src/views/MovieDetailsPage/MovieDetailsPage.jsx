...
export default class MovieDetailsPage extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await axios.get(
      `https://api.themoviedb.org/3/movie/${movieId}?api_key=0f42664b7f6700c34263c8262c49b65b&language=en-US`,
    );
  ...
  render() {
    ...
    const imageCheck = poster_path ? `https://image.tmdb.org/t/p/w500${poster_path}` : defaultImage;

    return (
      <div className={`container`}>
        <button className={styles.button} type="button" onClick={this.hendleGoBack}>
          Go back
        </button>
